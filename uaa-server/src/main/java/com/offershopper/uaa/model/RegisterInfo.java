...
import com.offershopper.uaa.model.AddressBean;

@Document(collection = "tempRegister")
public class RegisterInfo {
	...
	public String toString() {
		return "RegisterInfo [firstName=" + firstName + ", lastName=" + lastName + ", password=" + password + ", role="
				+ role + ", mobileNo=" + mobileNo + ", email=" + email + ", dob=" + dob + ", address=" + address
				+ ", gender=" + gender + ", spinCount=" + spinCount + ", osCash=" + osCash + ", shopAddress="
				+ shopAddress + ", vendorMobileNo=" + vendorMobileNo + ", offerIdList=" + offerIdList + ", timestamp="
				+ timestamp + "]";
	}
	...
	public RegisterInfo(String email , String password , String role) {
		this.email=email;
		this.password=password;
		this.role=role;
	}
	...
	public RegisterInfo(String firstName, String lastName,
