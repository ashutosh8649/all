...
public class RetrieveMessagesFromGenericQueue { 
  // to show the logs
  private static final Logger log = LoggerFactory.getLogger(OfferDatabaseServiceApplication.class);

  // listing to generic queue
  @RabbitListener(queues = OfferDatabaseServiceApplication.QUEUE_GENERIC_NAME)
