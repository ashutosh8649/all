...
@Service
public class RetrieveMessagesFromGenericQueue { // to show the logs
  private static final Logger log = LoggerFactory.getLogger(CarryBagDatabaseServiceApplication.class);

  // listing to generic queue
  @RabbitListener(queues = CarryBagDatabaseServiceApplication.QUEUE_GENERIC_NAME)
