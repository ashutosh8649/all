...
public class RetrieveMessagesFromGenericQueue {
	//to show the logs
    private static final Logger log = LoggerFactory.getLogger(ReferralDatabaseServiceApplication.class);
   
    //listing to generic queue
    @RabbitListener(queues = ReferralDatabaseServiceApplication.QUEUE_GENERIC_NAME)
