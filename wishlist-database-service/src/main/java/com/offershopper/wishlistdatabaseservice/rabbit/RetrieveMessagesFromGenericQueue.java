...
public class RetrieveMessagesFromGenericQueue { // to show the logs
  private static final Logger log = LoggerFactory.getLogger(WishlistDatabaseServiceApplication.class);

  // listing to generic queue
  @RabbitListener(queues = WishlistDatabaseServiceApplication.QUEUE_GENERIC_NAME)
