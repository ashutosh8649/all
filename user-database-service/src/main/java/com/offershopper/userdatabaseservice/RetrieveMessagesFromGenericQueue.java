...
public class RetrieveMessagesFromGenericQueue {
	//to show the logs
    private static final Logger log = LoggerFactory.getLogger(UserDatabaseServiceApplication.class);
   
    //listing to generic queue
    @RabbitListener(queues = UserDatabaseServiceApplication.QUEUE_GENERIC_NAME)
