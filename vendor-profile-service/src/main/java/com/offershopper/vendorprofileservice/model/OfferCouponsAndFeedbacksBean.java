...
public class OfferCouponsAndFeedbacksBean {
  ...
  private List<CouponAndFeedbackModifiedBean> couponsAndFeedbackList=new ArrayList<CouponAndFeedbackModifiedBean>();
  ...
  public List<CouponAndFeedbackModifiedBean> getCouponsAndFeedbackList() {
    return couponsAndFeedbackList;
  }

  public void setCouponsAndFeedbackList(List<CouponAndFeedbackModifiedBean> couponsAndFeedbackList) {
    this.couponsAndFeedbackList = couponsAndFeedbackList;
  }
